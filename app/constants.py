...
#   2 req/s → 10% 429
#   3 req/s → 60% 429
# Сначала держали 2 req/s, но в проде после батчинга Sheets (запросы перестали
# естественно растягиваться между Sheets-write'ами) бот начал упираться в
# rate limit submit-endpoint'а — много 429-в-`needs_attention`. Снизили до
# 1 req/s 2026-05-05 — безопасный уровень из probe. Минус: ~2x медленнее
# (300 задач за ~10 мин вместо 5), но без массовых 429.
WB_RATE_LIMIT_RPS = 1
